...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/asgi-csrf-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12281&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/asgi-csrf-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `asgi-csrf` can be installed with:

```
conda install asgi-csrf
```

It is possible to list all of the versions of `asgi-csrf` available on your platform with:
